...
import { Plus, Trash2, Calendar, PieChart, Target } from 'lucide-react'
...
export default function Investments() {
  ...
  const investmentCategories = state.categories.filter(cat => cat.type === 'investment')
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        <div className="animate-slide-up">
          <h1 className="text-3xl font-bold gradient-text mb-2">Investments</h1>
          <p className="text-gray-600 text-lg">Track your investments and build your future goals</p>
        </div>
        <button 
          onClick={() => setShowForm(true)}
          className="bg-purple-600 hover:bg-purple-700 text-white font-medium px-6 py-3 rounded-lg transition-colors flex items-center space-x-2 animate-bounce-in"
        >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-4xl font-bold text-purple-600">
              {formatCurrency(totalInvestments, user)}
            </p>
            <div className="flex items-center mt-3 text-purple-600">
              <Target className="w-5 h-5 mr-2" />
              <span className="text-sm font-medium">Building your future</span>
            </div>
          </div>
          <div className="p-4 bg-gradient-to-br from-purple-100 to-violet-100 rounded-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="input"
                placeholder="e.g., Stock purchase, Bond investment, Real estate fund"
                required
              />
            </div>
            ...
            <div className="flex space-x-4">
              <button type="submit" className="bg-purple-600 hover:bg-purple-700 text-white font-medium px-6 py-3 rounded-lg transition-colors flex-1 flex items-center justify-center">
      ...
      <div className="card animate-slide-up" style={{ animationDelay: '300ms' }}>
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-bold text-gray-900">Investment History</h3>
        ...
        {investmentTransactions.length > 0 ? (
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p className="text-xl font-medium mb-2">No investment transactions yet</p>
            <p className="text-sm">Start by adding your first investment to track your future goals</p>
          </div>
        )}
      </div>
    </div>
